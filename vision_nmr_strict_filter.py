...
class Filter:
    class Valves(BaseModel):
        ...
        nmr_keywords: str = Field(
            default="nmr,1h,¹h,13c,¹³c,19f,¹⁹f,31p,³¹p,11b,¹¹b,dept,dept-135,dept-90,apt,hsqc,hmbc,hmqc,cosy,noesy,roesy,tocsy,inadequate,ppm,cdcl3,cdcl₃,dmso-d6,dmsod6,cd3od,d2o,c6d6,tms,spectrum,spectra,chemical shift,coupling,multiplet,singlet,doublet,triplet,quartet",
    ...
    def _detect_nmr(self, body: dict) -> bool:
        ...
        specific_nmr_terms = ["ppm", "13c", "¹³c", "1h", "¹h", "nmr", "spectrum", "spectra", 
